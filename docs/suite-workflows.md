...
Current source baseline: ZeroSlack 0.22.0, Pinloom 0.4.0, WaveWorkbench 0.12.0, RegMapWorkbench 0.3.0.
The following workflows are implemented. Each application remains an independent repository.
Shared visual behavior is specified in [suite-ui.md](suite-ui.md); transport is specified in
[suite-app-protocol.md](suite-app-protocol.md).
