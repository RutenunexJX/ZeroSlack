...
QList<GlobalControlItem> GlobalControlService::commandItems() const
{
    return {
        ...
        item(GlobalControlItemKind::Command, QStringLiteral("toggleNavigation"), QStringLiteral("Toggle Navigation"), QStringLiteral("View")),
        item(GlobalControlItemKind::Command, QStringLiteral("toggleProblems"), QStringLiteral("Toggle Problems"), QStringLiteral("View")),
        item(GlobalControlItemKind::Command, QStringLiteral("toggleActivity"), QStringLiteral("Toggle Activity / Output"), QStringLiteral("View")),
        item(GlobalControlItemKind::Command, QStringLiteral("toggleRtlInsights"), QStringLiteral("Toggle RTL Insights"), QStringLiteral("View")),
