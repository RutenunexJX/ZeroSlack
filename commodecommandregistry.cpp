...
const QList<ComModeCommandMetadata>& comModeCommandRegistry()
{
    static const QList<ComModeCommandMetadata> registry = {
        ...
        {QStringLiteral("c"),
         false,
         ComModeCommandInputKind::Fixed,
         QStringLiteral("column-clear"),
         QStringLiteral("C-family prefix"),
         QStringLiteral("Prefix for column and clear commands.")},
        {QStringLiteral("cn"),
         true,
         ComModeCommandInputKind::Fixed,
         QStringLiteral("column"),
         QStringLiteral("Column numbers"),
         QStringLiteral("Open the column number tool.")},
        {QStringLiteral("si"),
         true,
         ComModeCommandInputKind::Fixed,
