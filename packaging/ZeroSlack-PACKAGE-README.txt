...
Release root: E:\PinloomRoot\AppPackage\AppSuite-ElaWidgetTools

Run ZeroSlack.exe. Keep the Runtime, WaveWorkbench, and Toolchain directories
beside ZeroSlack-win64 under AppSuite-ElaWidgetTools\Apps. Runtime provides
the shared SuiteApp broker; WaveWorkbench provides waveform views and simulation;
...
This ElaWidgetTools branch has its own package directory. The main branch's
AppSuite directory and its Windows shortcuts are unaffected. Shortcuts for
this branch should target
AppSuite-ElaWidgetTools\Apps\ZeroSlack-win64\ZeroSlack.exe. Package, toolchain,
build-cache, staging, and Verilator object directory names supplied by this release contain
...
font license text is provided in FontAwesome-LICENSE.txt beside ZeroSlack.exe.
