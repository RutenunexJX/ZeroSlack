...
- Definition, completion, smart/all-symbol and typed symbol scoring, context-aware completion, typed symbol and `SymbolInfo` completion, scope/current-module, relationship-driven completion, relationship, hierarchy, reference, diagnostics, and search services
