...
- Global app control is available through Double Shift from editor and non-editor focus, with search/dispatch results sourced from ProjectModel, SemanticIndexSnapshot, feature services, and existing coordinators instead of UI file scans or direct analysis
