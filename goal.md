...
- I4 is current: delete the legacy carrier APIs, compatibility taxonomy surface, and remaining adapter conversions. The unused `semanticcollectoradapter` source/header are deleted and guarded against returning.
