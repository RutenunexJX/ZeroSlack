...
Alternate-mode command completion state now lives behind `AlternateCommandService`.
`MyCodeEditor` consumes service-owned normalized input, matched commands, and popup visibility instead of assembling alternate command completion state locally.
