...
- Inline commands are layered by intent: `CompletionService` owns semantic `;cmd` behavior, `CodeTemplateService` owns `;;cmd` template expansion, and `;:` remains a reserved namespace with no active behavior.
