...
- `SourceNavigationService` owns SystemVerilog include directive, package-import, identifier hit-testing, source navigation target selection, and editor symbol action context assembly.
