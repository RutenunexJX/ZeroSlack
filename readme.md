...
- `FormatterService` owns conservative editor formatting reports, including indentation, simple declaration-block alignment, and simple ANSI port-list alignment. The editor invokes it and applies the returned text as a single undoable edit, while formatter policy stays outside UI code.
