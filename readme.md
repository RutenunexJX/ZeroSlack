...
- Current Fold Region / Fold Shelf polish in the worktree adds visible status-bar mode chips, live Fold Region range preview with gutter badges, Fold Shelf dock/list active styling, and Fold Shelf text-input blocking while drag mode is active.
