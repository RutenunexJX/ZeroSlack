...
- `AnalysisScheduler` refreshes open-document semantic snapshots when workspace analysis starts and again when it finishes, keeping dirty editor buffers ahead of background workspace publication while retaining a finish-time reconciliation pass.
