...
- `FormatterService` owns conservative editor formatting reports, including indentation and simple declaration-block alignment. The editor invokes it and applies the returned text as a single undoable edit, while formatter policy stays outside UI code.
